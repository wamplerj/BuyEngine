...
public class SupplierServiceTests
{
    ...
    {
        _supplierRepository.Setup(sr => sr.GetAllAsync(5, 0)).ReturnsAsync(new PagedList<Supplier>(new List<Supplier>(), 1, 1, 1));
        var result = await _supplierService.GetAllAsync(5);
    ...
    public async Task Adding_A_Valid_Supplier_Succeeds()
    {
        ...
        var supplier = new Supplier { Name = "Test", Notes = "Test Notes", WebsiteUrl = "http://www.testurl.com" };
